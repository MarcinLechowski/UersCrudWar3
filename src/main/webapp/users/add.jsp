        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <a href="<c:url value="/user/list"/>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Wróć</a>
                </div>
                <!-- Page Heading -->
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-header py-3">
                        <a href="<c:url value="/users/add.jsp"/>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"></a>
